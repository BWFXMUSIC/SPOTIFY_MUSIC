...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BWFXMUSIC/SPOTIFY_MUSIC",
)
...
# ------------------------------------------------------------------------
# -------------------------------------------------------------------------
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BWF_MUSIC1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/MUSICBOT_OWNER")
SOURCE = getenv("SOURCE", "https://t.me/L2R_KING")
CHAT = getenv("CHAT", "https://t.me/ALL_QUIZ_TAME")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
